            ...
            <div className="flex flex-col xl:flex-row xl:items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {/* Project Card */}
                  <div className="bg-white/80 dark:bg-darkblack-600/80 backdrop-blur-sm rounded-lg p-3 border border-white/20 dark:border-darkblack-300/20 shadow-sm hover:shadow-md transition-all duration-200">
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">ID: {currentContract?.project_id || "N/A"}</p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between">
                          <p className="text-xs text-gray-500 dark:text-gray-400">ID: {currentContract?.lot_id || "N/A"}</p>
                              ...
                              {!isReadOnly && (
                                <button
                                  onClick={() => {
                                    ...
                                    const updatedSchedule = schedule.map((payment, paymentIdx) => 
          ...
          <div className="bg-white dark:bg-darkblack-600 rounded-lg p-6 w-full max-w-md mx-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
              {selectedPayment?.isCapitalPayment 
                ...
                : `Pago #${selectedPayment.number} - ${translatePaymentType(selectedPayment.payment_type)}`
              }
            </p>
                  ...
                  try {
                    ...
                    if (selectedPayment?.isCapitalPayment) {
                      ...
                      const response = await fetch(
                        `${API_URL}/api/v1/projects/${currentContract?.project_id}/lots/${currentContract?.lot_id}/contracts/${currentContract?.id}/capital_payment`,
                        {
                          method: "POST",
                          headers: {
                      ...
                      const totalAmount = paymentAmount + interestAmount;
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                onClick={() => {
                  ...
                  const updatedSchedule = schedule.map(payment => 
                    (payment.id || schedule.indexOf(payment)) === editingMora
                      ? { 
                          ...payment, 
