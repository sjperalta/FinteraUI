    ...
    <div className="animate-fade-in-up">
      <div className="text-center max-w-lg px-1.5 m-auto">
        ...
        <p className="text-lg text-gray-700 dark:text-gray-300 font-medium leading-relaxed">
          Fintera te ayuda a administrar tus pagos y financiamientos de manera inteligente y eficiente.
        </p>
        ...
        <div className="mt-8 grid grid-cols-1 gap-4">
          <div className="flex items-center justify-center space-x-3 p-3 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl border border-white/20 dark:border-gray-700/50">
            ...
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Gestión completa de contratos</span>
          </div>
          ...
          <div className="flex items-center justify-center space-x-3 p-3 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl border border-white/20 dark:border-gray-700/50">
            ...
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Procesos automatizados</span>
          </div>
          ...
          <div className="flex items-center justify-center space-x-3 p-3 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl border border-white/20 dark:border-gray-700/50">
            ...
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Seguridad garantizada</span>
          </div>
        </div>
      </div>
    </div>
