...
function TotalWidget({ statistics }) {
  // Debug: Log the received statistics to see what we're getting
  console.log('Statistics received in TotalWidget:', statistics);
  console.log('Payment Reserve:', statistics?.payment_reserve);
  console.log('Payment Down Payment:', statistics?.payment_down_payment);
  console.log('Payment Installments:', statistics?.payment_installments);
  ...
  return (
    <div className="mb-[32px] w-full">
      ...
      <div className="grid grid-cols-1 gap-[16px] lg:grid-cols-3 mt-6">
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-4 border border-gray-200 dark:border-darkblack-500">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-bgray-500 dark:text-bgray-300">Reservas</p>
              <p className="text-xl font-bold text-warning-500">L {formatNumber(statistics?.payment_reserve || 0)}</p>
            </div>
        ...
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-4 border border-gray-200 dark:border-darkblack-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl font-bold text-success-500">L {formatNumber(statistics?.payment_down_payment || 0)}</p>
            </div>
        ...
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-4 border border-gray-200 dark:border-darkblack-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl font-bold text-orange-500">L {formatNumber(statistics?.payment_installments || 0)}</p>
            </div>
