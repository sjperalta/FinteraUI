      ...
      <div className="grid grid-cols-1 gap-[16px] lg:grid-cols-2 xl:grid-cols-5 mt-6">
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-4 border border-gray-200 dark:border-darkblack-500 hover:shadow-md transition-all duration-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-bgray-500 dark:text-bgray-300">{t('widgets.reservations')}</p>
        ...
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-4 border border-gray-200 dark:border-darkblack-500 hover:shadow-md transition-all duration-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-bgray-500 dark:text-bgray-300">{t('widgets.downPayment')}</p>
        ...
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-4 border border-gray-200 dark:border-darkblack-500 hover:shadow-md transition-all duration-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-bgray-500 dark:text-bgray-300">{t('widgets.installments')}</p>
              <p className="text-xl font-bold text-orange dark:text-orange">L {formatNumber(statistics?.payment_installments || 0)}</p>
            </div>
        ...
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-4 border border-gray-200 dark:border-darkblack-500 hover:shadow-md transition-all duration-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-bgray-500 dark:text-bgray-300">{t('widgets.capitalRepayment')}</p>
              <p className="text-xl font-bold text-gray-700 dark:text-gray-300">L {formatNumber(statistics?.payment_capital_repayment || 0)}</p>
            </div>
            <div className="p-2 bg-gray-100 dark:bg-darkblack-500/30 rounded-lg">
        ...
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-4 border border-gray-200 dark:border-darkblack-500 hover:shadow-md transition-all duration-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-bgray-500 dark:text-bgray-300">{t('widgets.lateInterest')}</p>
              <p className="text-xl font-bold text-red-600 dark:text-red-400">L {formatNumber(statistics?.total_interest || 0)}</p>
            </div>
